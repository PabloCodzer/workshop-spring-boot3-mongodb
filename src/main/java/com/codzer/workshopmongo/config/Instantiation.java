...
import com.codzer.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO( "vai la", sdf.parse("21/03/2018"),new AuthorDTO(alex) );
		CommentDTO c2 = new CommentDTO( "sei aham ", sdf.parse("22/03/2018"),new AuthorDTO(bob) );
		CommentDTO c3 = new CommentDTO( "tah taaaaah", sdf.parse("23/03/2018"),new AuthorDTO(alex) );
